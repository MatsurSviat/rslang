...
export async function paginationUpperintermediate(
  totalPages: number,
  page: number
) {
  ...
  <div class="word-wrapper">
    ...
    `;
    audioBtnWordPlay();
    paginationUpperintermediate(totalPages, page - 1);
  }
  ...
  async function startpageHandler() {
    paginationUpperintermediate(totalPages, 1);
  }
  ...
  <div class="word-wrapper">
    ...
    audioBtnWordPlay();
    if (btnId != undefined) {
      paginationUpperintermediate(totalPages, +btnId);
    }
  }
