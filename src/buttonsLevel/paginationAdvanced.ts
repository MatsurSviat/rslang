...
export async function paginationAdvanced(totalPages: number, page: number) {
  ...
  <div class="word-wrapper">
    ...
    `;
    audioBtnWordPlay();
    paginationAdvanced(totalPages, page - 1);
  }
  ...
  async function startpageHandler() {
    paginationAdvanced(totalPages, 1);
  }
  ...
  <div class="word-wrapper">
    ...
    audioBtnWordPlay();
    if (btnId != undefined) {
      paginationAdvanced(totalPages, +btnId);
    }
  }
