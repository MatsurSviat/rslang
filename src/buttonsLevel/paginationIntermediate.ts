...
export async function paginationIntermediate(totalPages: number, page: number) {
  ...
  <div class="word-wrapper">
    ...
    `;
    audioBtnWordPlay();
    paginationIntermediate(totalPages, page - 1);
  }
  ...
  async function startpageHandler() {
    paginationIntermediate(totalPages, 1);
  }
  ...
  <div class="word-wrapper">
    ...
    audioBtnWordPlay();
    if (btnId != undefined) {
      paginationIntermediate(totalPages, +btnId);
    }
  }
