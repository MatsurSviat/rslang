...
export async function paginationPreintermediate(
  totalPages: number,
  page: number
) {
  ...
  <div class="word-wrapper">
    ...
    `;
    audioBtnWordPlay();
    paginationPreintermediate(totalPages, page - 1);
  }
  ...
  async function startpageHandler() {
    paginationPreintermediate(totalPages, 1);
  }
  ...
  <div class="word-wrapper">
    ...
    audioBtnWordPlay();
    if (btnId != undefined) {
      paginationPreintermediate(totalPages, +btnId);
    }
  }
