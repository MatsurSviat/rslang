...
export async function profiencyPagination(totalPages: number, page: number) {
  ...
  <div class="word-wrapper">
    ...
    `;
    audioBtnWordPlay();
    profiencyPagination(totalPages, page - 1);
  }
  ...
  async function startpageHandler() {
    profiencyPagination(totalPages, 1);
  }
  ...
  <div class="word-wrapper">
    ...
    audioBtnWordPlay();
    if (btnId != undefined) {
      profiencyPagination(totalPages, +btnId);
    }
  }
